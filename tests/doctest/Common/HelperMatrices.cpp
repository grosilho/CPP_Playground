...
TEST_CASE_TEMPLATE("Constant matrix", S, ET_CRTP_type<double>)
{
...
TEST_CASE_TEMPLATE("Zero matrix", S, ET_CRTP_type<double>)
{
...
TEST_CASE_TEMPLATE("Identity Matrix", S, ET_CRTP_type<double>)
{
